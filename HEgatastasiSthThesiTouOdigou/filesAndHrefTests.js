function addfilesTests() {
	...
	testJS.src = httpLink + hostName + "/HEgatastasiSthThesiTouOdigou/test.js";
...
function filesHrefTests() {
	...
	for (let i = 0; i < imgPhotoQuestion.length; i++) {
		imgPhotoQuestion.item(i).src = httpLink + hostName + "/Photos/HEgatastasiSthThesiTouOdigou/kef2-" + (i + 1) + ".png";
	}
}
